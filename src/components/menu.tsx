...
const MenuItems = ({ onClose, theme, colorMode }: Props) => {
	...
	return (
		<>
			...
			<Divider />
			<List>
				<ListItemButton onClick={() => nav(`/${inputURL}/posts`)} selected={window.location.hash.includes("/post")}>
					<ListItemIcon>
						<PushPinIcon />
					</ListItemIcon>
					<ListItemText primary="Posts" />
				</ListItemButton>
				<ListItemButton onClick={() => nav(`/${inputURL}/pages`)} selected={window.location.hash.includes("/page")}>
					<ListItemIcon>
						<DescriptionIcon />
					</ListItemIcon>
			...
			<List>
				...
				<ListItemButton onClick={() => nav(`/${inputURL}/about`)} selected={window.location.hash.includes("/about")}>
					<ListItemIcon>
						<CoPresentIcon />
					</ListItemIcon>
